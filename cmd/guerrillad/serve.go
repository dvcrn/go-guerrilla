...
import (
	...
	"github.com/dvcrn/go-guerrilla/log"

	// enable the Redis redigo driver
	_ "github.com/dvcrn/go-guerrilla/backends/storage/redigo"

	// Choose iconv or mail/encoding package which uses golang.org/x/net/html/charset
	//_ "github.com/dvcrn/go-guerrilla/mail/iconv"
	_ "github.com/dvcrn/go-guerrilla/mail/encoding"
